...
class Country(models.Model):
    ...
    NAME_EN = models.CharField(max_length=100, null=True, blank=True, db_column='NAME_EN')
    ...
    def __str__(self):
        return self.NAME_KH + " - " + self.NAME_EN
...
class Commune(models.Model):
    ID = models.AutoField(primary_key=True, db_column='ID')
    DISTRICT_ID = models.ForeignKey(District, on_delete=models.CASCADE, db_column='DISTRICT_ID')
...
class Village(models.Model):
    ID = models.AutoField(primary_key=True, db_column='ID')
    COMMUNE_ID = models.ForeignKey(Commune, on_delete=models.CASCADE, db_column='COMMUNE_ID')
    CODE = models.CharField(max_length=50, null=True, blank=True, db_column='CODE')
    NAME_KH = models.CharField(max_length=150, null=True, blank=True, db_column='NAME_KH')
