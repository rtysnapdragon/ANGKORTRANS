...
class Notification(models.Model):
    ...
    CreatedBy = models.CharField(max_length=50,db_column="CREATED_BY",blank=True,null=True)
    UpdatedBy = models.CharField(max_length=50,db_column="UPDATED_BY",blank=True,null=True)
