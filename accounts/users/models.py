...
class UserProfile(models.Model):
    USER_ID = models.OneToOneField(User, on_delete=models.CASCADE, primary_key=True,name="name_user_profile_id", db_column='USER_ID')
    ...
    PROVINCE_ID = models.ForeignKey(Province, on_delete=models.SET_NULL, null=True, blank=True, db_column='PROVINCE_ID')
    DISTRICT_ID = models.ForeignKey(District, on_delete=models.SET_NULL, null=True, blank=True, db_column='DISTRICT_ID')
    COMMUNE_ID = models.ForeignKey(Commune, on_delete=models.SET_NULL, null=True, blank=True, db_column='COMMUNE_ID')
